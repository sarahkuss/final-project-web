...
export default function GetInvolved () {
  return (
    <>
        <h1 className="GI text-center">Ways to Get Involved</h1>
    <Container className="getinvolved-container" fluid>
      <section className="GI-section">
      <Row className="GI-row">
          <h3 className="text-center">There are several ways you can make a difference:</h3>
        <Col className="ways-col" sm={12} md={6}>
      ...
      <Row className="line-row"></Row>

      <Row className="help-row">
        <h3>Ways to help at home:</h3>
        <Col className="home-col" sm={12} md={6}>
