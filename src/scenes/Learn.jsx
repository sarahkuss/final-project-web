...
export default function Learn () {
  return (
    <>
      <h1 className='learn-more text-center'>Learn More</h1>
    <Container className='learn-container' fluid>
      <section className='content-section'>
      <Row className='learn-row'>
        <Col className='aboutCC-col'>
          <h2 className='text-center'>About Conservation Connect:</h2>
      ...
      <Row className='what-row'>
        <Col className='whatis-col'>
          <h2 className='text-center'>What is Conservation?</h2>
      ...
      <Row className='why-row'>
        <Col className='why-col'>
          ...
          <p><strong>3. Ethical Responsibility:</strong> As human beings, we have a moral obligation to protect and conserve animals and their habitats.</p>
        </Col>
